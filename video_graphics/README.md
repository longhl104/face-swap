...
| `Part2ModelOverview` — two jobs, FaceNet → identity vector, Generator, compress/redraw, U-Net skip connections | `scenes/part2_model_overview.py` | Part 2, 0:35–1:55 (mô hình hoạt động như thế nào) |
